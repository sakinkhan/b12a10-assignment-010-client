    ...
    <div className="navbar bg-base-100 shadow-lg py-4">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex="-1"
            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow space-y-2 font-secondary"
          >
            {links}
          </ul>
        </div>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 space-x-5 font-secondary">
          {links}
        </ul>
      </div>
